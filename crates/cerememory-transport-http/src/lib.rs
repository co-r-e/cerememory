...
async fn encode_store(
    ...
    Json(req): Json<EncodeStoreRequest>,
...
async fn encode_update(
    ...
    Json(mut req): Json<EncodeUpdateRequest>,
...
async fn recall_query(
    State(engine): State<AppState>,
    Json(req): Json<RecallQueryRequest>,
...
async fn recall_associate(
    State(engine): State<AppState>,
    Path(record_id): Path<Uuid>,
    Json(mut req): Json<RecallAssociateRequest>,
...
async fn lifecycle_decay_tick(
    State(engine): State<AppState>,
    Json(req): Json<DecayTickRequest>,
